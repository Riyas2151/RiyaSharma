...
const FullScreenNav = () => {
    return (
        <div id='fullscreen' className='h-screen text-white overflow-hidden  w-full absolute bg-black'>
          ...
          <div className="flex justify-between items-start p-2 w-full">
            <div className="">
        <svg xmlns="http://www.w3.org/2000/svg" width="103" height="64" viewBox="0 0 103 44">
      ...
      <div className="h-20 w-20 relative cursor-pointer pt-2">
        <div className='h-24 w-1 bg-[#D3FD50] -rotate-50 origin-top absolute'></div>
        <div className='h-24 w-1  bg-[#D3FD50] right-0 rotate-50 origin-top absolute'></div>
        ...
        <div></div>
            ...
            <div className="py-24" id='alllinks'>
                <div className=' link relative border-t-1  border-white'>
                    ...
                    <div className="movelink absolute top-0 flex text-black bg-[#D3FD50] ">
                        <div className='flex moveX items-center'>
                            <h2 className='whitespace-nowrap font-[font2] leading-[0.8] pt-3 text-center text-[8vw] uppercase'>See What we Did</h2>
                            <img className='h-[6vw] rounded-full w-[16vw] shrink-0 object-cover ' src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
                            <h2 className='whitespace-nowrap font-[font2] leading-[0.8] pt-3 text-center text-[8vw] uppercase'>See What we Did</h2>
                            <img className='h-[6vw] rounded-full w-[16vw] shrink-0 object-cover ' src="https://k72.ca/uploads/caseStudies/PJC/Thumbnails/PJC_SiteK72_Thumbnail_640x290-640x290.jpg" alt="" />
                        </div>
